...
- **客户案例查询** — 检索 AWS 客户成功案例，了解不同行业的真实使用场景
...
| 参数 | 是否必填 | 说明 |
|------|----------|------|
| Model ID | 已预填 GLM-5（效果最好） | 可选 GLM-5、MiniMax M2.5 |
...
> 详细图文步骤请参考 [飞书机器人配置手册](docs/feishu-setup-zh.md#第六步配置事件订阅)（第六步 ~ 第九步）
...
| GLM-5 (Zhipu AI) | $1.00 | $3.20 | ❌ | 最佳效果（推荐） |

> **模型选择建议：**
> - **GLM-5（推荐）** — 回答最详细、最易懂，工具调用能力最强，整体体验最好
> - **MiniMax M2.5** — 回答质量不错，价格最低，适合对成本敏感的场景
...
<img src="docs/images/zh/token-cost-display.png" width="500" alt="Token消耗和成本显示示例">
